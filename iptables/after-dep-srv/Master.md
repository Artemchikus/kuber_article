```bash
# Generated by iptables-save v1.8.7 on Sat Dec  9 17:22:20 2023
*mangle
...
COMMIT
# Completed on Sat Dec  9 17:22:20 2023
# Generated by iptables-save v1.8.7 on Sat Dec  9 17:22:20 2023
*filter
:INPUT ACCEPT [0:0]
:FORWARD ACCEPT [0:0]
...
# Generated by iptables-save v1.8.7 on Sat Dec  9 17:22:20 2023
*nat
:PREROUTING ACCEPT [158:10559]
:INPUT ACCEPT [156:10394]
:OUTPUT ACCEPT [380:22780]
:POSTROUTING ACCEPT [423:26678]
:DOCKER - [0:0]
:DOCKER_OUTPUT - [0:0]
...
:KUBE-PROXY-CANARY - [0:0]
:KUBE-SEP-E7QDI4WX3A3GWTGP - [0:0]
:KUBE-SEP-IT2ZTR26TO4XFPTO - [0:0]
:KUBE-SEP-M6LBIRCLGOFYIL5C - [0:0]
...
-A DOCKER_OUTPUT -d 192.168.49.1/32 -p tcp -m tcp --dport 53 -j DNAT --to-destination 127.0.0.11:43725
-A DOCKER_OUTPUT -d 192.168.49.1/32 -p udp -m udp --dport 53 -j DNAT --to-destination 127.0.0.11:44576
...
-A KUBE-SEP-E7QDI4WX3A3GWTGP -s 10.244.1.2/32 -m comment --comment "default/react-np:http" -j KUBE-MARK-MASQ
-A KUBE-SEP-E7QDI4WX3A3GWTGP -p tcp -m comment --comment "default/react-np:http" -m tcp -j DNAT --to-destination 10.244.1.2:3000
...
-A KUBE-SEP-M6LBIRCLGOFYIL5C -s 10.244.0.3/32 -m comment --comment "default/react-np:http" -j KUBE-MARK-MASQ
-A KUBE-SEP-M6LBIRCLGOFYIL5C -p tcp -m comment --comment "default/react-np:http" -m tcp -j DNAT --to-destination 10.244.0.3:3000
...
-A KUBE-SERVICES -d 10.105.124.252/32 -p tcp -m comment --comment "default/react-np:http cluster IP" -m tcp --dport 80 -j KUBE-SVC-LPLI5PP7N5LEMN6C
...
-A KUBE-SVC-LPLI5PP7N5LEMN6C ! -s 10.244.0.0/16 -d 10.105.124.252/32 -p tcp -m comment --comment "default/react-np:http cluster IP" -m tcp --dport 80 -j KUBE-MARK-MASQ
