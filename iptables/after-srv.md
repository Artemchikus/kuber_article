```bash
# Generated by iptables-save v1.8.7 on Sat Dec  9 11:40:39 2023
*mangle
...
COMMIT
# Completed on Sat Dec  9 11:40:39 2023
# Generated by iptables-save v1.8.7 on Sat Dec  9 11:40:39 2023
*filter
:INPUT ACCEPT [0:0]
:FORWARD ACCEPT [0:0]
...
# Generated by iptables-save v1.8.7 on Sat Dec  9 11:40:39 2023
*nat
:PREROUTING ACCEPT [164:11848]
:INPUT ACCEPT [157:10785]
:OUTPUT ACCEPT [319:19080]
:POSTROUTING ACCEPT [344:21038]
:CNI-408d347e33f8150321b98dc0 - [0:0]
:CNI-4c42234ec21533e7bce9e7cc - [0:0]
:DOCKER - [0:0]
:DOCKER_OUTPUT - [0:0]
:DOCKER_POSTROUTING - [0:0]
:KUBE-EXT-VUGVVJAHU4RL2TIW - [0:0]
:KUBE-KUBELET-CANARY - [0:0]
:KUBE-MARK-MASQ - [0:0]
:KUBE-NODEPORTS - [0:0]
:KUBE-POSTROUTING - [0:0]
:KUBE-PROXY-CANARY - [0:0]
:KUBE-SEP-6X3WIXWFLXPKXKEP - [0:0]
...
-A POSTROUTING -s 10.244.0.2/32 -m comment --comment "name: \"bridge\" id: \"36c041dd6034aab9676179d7e543adfa6ad0630a26997db00b485956116343ed\"" -j CNI-4c42234ec21533e7bce9e7cc
-A POSTROUTING -s 10.244.0.3/32 -m comment --comment "name: \"bridge\" id: \"56c3d23c33be5ee932d43973edf75726b3c466043818c7266efa6e5e8ef13697\"" -j CNI-408d347e33f8150321b98dc0
-A CNI-408d347e33f8150321b98dc0 -d 10.244.0.0/16 -m comment --comment "name: \"bridge\" id: \"56c3d23c33be5ee932d43973edf75726b3c466043818c7266efa6e5e8ef13697\"" -j ACCEPT
-A CNI-408d347e33f8150321b98dc0 ! -d 224.0.0.0/4 -m comment --comment "name: \"bridge\" id: \"56c3d23c33be5ee932d43973edf75726b3c466043818c7266efa6e5e8ef13697\"" -j MASQUERADE
-A CNI-4c42234ec21533e7bce9e7cc -d 10.244.0.0/16 -m comment --comment "name: \"bridge\" id: \"36c041dd6034aab9676179d7e543adfa6ad0630a26997db00b485956116343ed\"" -j ACCEPT
-A CNI-4c42234ec21533e7bce9e7cc ! -d 224.0.0.0/4 -m comment --comment "name: \"bridge\" id: \"36c041dd6034aab9676179d7e543adfa6ad0630a26997db00b485956116343ed\"" -j MASQUERADE
-A DOCKER -i docker0 -j RETURN
-A DOCKER_OUTPUT -d 192.168.49.1/32 -p tcp -m tcp --dport 53 -j DNAT --to-destination 127.0.0.11:35485
-A DOCKER_OUTPUT -d 192.168.49.1/32 -p udp -m udp --dport 53 -j DNAT --to-destination 127.0.0.11:60680
...
-A KUBE-SERVICES -d 10.104.205.29/32 -p tcp -m comment --comment "default/vault cluster IP" -m tcp --dport 8200 -j KUBE-SVC-VUGVVJAHU4RL2TIW
